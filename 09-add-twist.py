# this program adds a small twist: the missiles get a bit faster, with every five points gained.
...
class Player(pywrap.ImageSprite):
    ...
    def shoot(self, game):
        bullet = Bullet(
            game, self.rect.x + self.rect.width, self.rect.y + self.rect.height / 2
        )
